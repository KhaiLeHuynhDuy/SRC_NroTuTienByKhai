...
public class ConstNpc {
    ...
    public static final String VEGETA_KE_CHUYEN
            = "Ngươi có đến một nơi tuyệt vời để up tnsm không?"
            + "Khi nào ngươi cần sự giúp đỡ của ta hãy đến đây nhé";
    public static final String KHIGAS = "Hiện Tại Chưa Có Thông Tin Gì!";
    ...
    public static final String HUONG_DAN_GIAI_DAU = "Mỗi ngày từ 21H đến 22H Giải đấu vũ trụ sẽ xảy ra 1 cuộc đại chiến\n"
            + "Người nào tìm thấy và giữ được Bệ Rồng 1 Sao sẽ mang phần thưởng về cho bang của mình trong vòng 1 ngày\n"
            + "1) Giữ bệ rồng trên người hơn 5 phút liên tục\n"
            + "2)Sau 30 phút tham gia tàu sẽ đón về và đang giữ bệ rồng trên người";
    ...
    public static final byte RONG_OMEGA = 36;
    public static final byte RONG_1S = 29;
...
//    public static final byte ONG_BUT = 103;
    ...
    public static final byte BERUS_DHVT = 76;
    public static final byte VEGETABNTT = 77;
    public static final byte HEART = 78;
    public static final byte QUOCKHANH = 80;
    public static final byte QUOCKHANH2 = 81;
    public static final byte SK20_10 = 99;
    public static final byte LY_TIEU_NUONG_CLTX = 95;
    ...
    //index gắp thú
    public static final int GAPTHUMENU = 752008;
    public static final int MENUGAPX1 = 752009;
    public static final int MENUGAPX10 = 752010;
    public static final int MENUGAPX100 = 752011;
    public static final int STOPGAP = 752012;
    //index quy lão kamê
    ...
    public static final int MENU_OPEN_KG = 578;
    public static final int MENU_OPENED_KG = 579;
    public static final int MENU_ACCEPT_GO_TO_KG = 580;
    //index than vu tru
    ...
    public static final int CONFIRM_REMOVE_ALL_ITEM_MAIL_BOX = 5115;
    public static final int CONFIRM_REMOVE_ALL_ITEM_RUONG_PHU = 5116;
    ...
    public static final int SET_TSTD = 1400;
    public static final int SET_TSNM = 1401;
    public static final int SET_TSXD = 1402;
    ...
    public static final int MENU_OPTION_USE_ITEM2013 = 2013;
    public static final int MENU_OPTION_USE_ITEM2014 = 2014;
    public static final int MENU_OPTION_USE_ITEM2015 = 2015;
    public static final int MENU_OPTION_USE_ITEM736 = 736;
    public static final int MENU_OPTION_USE_ITEM1105 = 1105;
    public static final int MENU_OPTION_USE_ITEM2114 = 2114;
    public static final int MENU_OPTION_USE_ITEM2115 = 2115;
    public static final int MENU_OPTION_USE_ITEM2116 = 2116;
    public static final int MENU_OPTION_USE_ITEM1618 = 1618;
    public static final int MENU_OPTION_USE_ITEM1619 = 1619;
    ...
    public static final int SHENRON_CONFIRM_HALLOWEEN = 561;
    public static final int SUMMON_SHENRON_HALLOWEN = 5456;
    public static final int TUTORIAL_RONG_XUONG = 5704;
    public static final int RONG_HALLOWEN = 5705;
    public static final int SHENRON_1_1_HALLOWEEN = 1231;
    ...
    //index menu rồng omega
    public static final int MENU_NOT_OPEN_GD = 500;
    public static final int MENU_OPEN_GD = 501;
    public static final int MENU_REWARD_GD = 502;
    //index menu osin
    ...
    //index menu bò mộng
    public static final int MENU_OPTION_LEVEL_SIDE_TASK = 666;
    public static final int MENU_OPTION_PAY_SIDE_TASK = 777;
    public static final int RUONG_GO = 500;
    ...
    public static final int SIDE_BOX_RUONG_PHU = 512;
    public static final int SIDE_BOX_MAIL_BOX = 513;
    public static final int SHOP_SU_KIEN_TET = 514;
}
