...
public class SkillUtil {
    ...
    public static int getTimeBienHinh(boolean lastLevel, int coolDown) { //thời gian biến hình
        int per = lastLevel ? 80 : 60;
//        int per = lastLevel ? 10 : 20;
...
//    }
    public static Skill createSkill(int tempId, int level) {
        ...
        SkillTemplate templateTD = nClassTD.getSkillTemplate(tempId);
        if (templateTD != null && templateTD.skillss != null && level - 1 < templateTD.skillss.size()) {
            skill = new Skill(templateTD.skillss.get(level - 1));
        }

        SkillTemplate templateNM = nClassNM.getSkillTemplate(tempId);
        if (templateNM != null && templateNM.skillss != null && level - 1 < templateNM.skillss.size()) {
            skill = new Skill(templateNM.skillss.get(level - 1));
        }

        SkillTemplate templateXD = nClassXD.getSkillTemplate(tempId);
        if (templateXD != null && templateXD.skillss != null && level - 1 < templateXD.skillss.size()) {
            skill = new Skill(templateXD.skillss.get(level - 1));
        }
...
//    public static int getTimeBienHinh(int level) { //thời gian tồn tại khỉ v
//        return (level + 5) * 10000;
//    }
...
//    }
    ...
    public static int getTimeBinh(int time) {
        return time;
    }
...
//EMTI
    ...
    public static boolean upSkillPet(List<Skill> skills, int index) {
        if (skills == null || skills.size() <= index) {
            return false;
        }
...
//        Skill skill = null;
//        try {
//            SkillTemplate skillTemplate = nClassTD.getSkillTemplate(tempId);
//            if (skillTemplate != null) {
//                skill = skillTemplate.skillss.get(level - 1);
//            }
//        } catch (Exception e) {
...
//        if (skill == null) {
//            try {
//                SkillTemplate skillTemplate = nClassNM.getSkillTemplate(tempId);
//                if (skillTemplate != null) {
//                    skill = skillTemplate.skillss.get(level - 1);
//                }
//            } catch (Exception ex) {
...
//        if (skill == null) {
//            try {
//                SkillTemplate skillTemplate = nClassXD.getSkillTemplate(tempId);
//                if (skillTemplate != null) {
//                    skill = skillTemplate.skillss.get(level - 1);
//                }
//            } catch (Exception ex) {
...
//
//        if (skill == null) {
//            return false; // Skill template not found in any class
//        }
//
//        skill = new Skill(skill);
//        if (index == 1) {
