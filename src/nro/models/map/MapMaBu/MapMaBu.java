...
//            if (!player.isPet || !player.isMiniPet || !player.isBoss) {
//            System.out.println(player.name + " nro.models.map.MapMaBu.MapMaBu.kickOutOfMapMabu()");
...
//                }
    ...
    private void ketthucmabu(Player player) {
        if (player != null && player.zone != null) {
//            if (!player.isPet || !player.isMiniPet || !player.isBoss) {
//            System.out.println(player.name + " nro.models.map.MapMaBu.MapMaBu.ketthucmabu()");
...
//                || !MapService.gI().isMapGiaidauvutru(player.zone.map.mapId)) {
