...
public class Saibamen4 extends Boss {
    ...
    public Saibamen4(Zone zone , int level, long dame, long hp) throws Exception {
        super(BossType.SAIBAMEN_4, new BossData(
                "số 4",
    ...
    public double injured(Player plAtt, double damage, boolean piercing, boolean isMobAttack) {
        ...
        damage = this.nPoint.subDameInjureWithDeff(damage);
            ...
            if (this.nPoint.hp == 0) {
                ...
                new Saibamen5(this.zone, 2, Util.nextInt(1000, 10000), BossType.SAIBAMEN_4);    
