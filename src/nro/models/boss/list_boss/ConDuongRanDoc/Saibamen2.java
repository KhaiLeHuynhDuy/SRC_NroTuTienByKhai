...
public class Saibamen2 extends Boss {
    ...
    public Saibamen2(Zone zone , int level, long dame, long hp) throws Exception {
        super(BossType.SAIBAMEN_2, new BossData(
                "số 2",
        ...
        if (!this.isDie()) {
            ...
            if (this.nPoint.hp == 0) {
                try {
                 ...
                 new Saibamen3(this.zone, 2, Util.nextInt(1000, 10000), BossType.SAIBAMEN_2);   
