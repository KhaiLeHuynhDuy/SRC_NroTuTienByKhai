...
public class Saibamen5 extends Boss {
    ...
    public Saibamen5(Zone zone , int level, long dame, long hp) throws Exception {
        super(BossType.SAIBAMEN_5, new BossData(
                "số 5",
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            ItemMap it = new ItemMap(this.zone, 1120, 3, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
           ...
           damage = this.nPoint.subDameInjureWithDeff(damage);
            ...
            if (this.nPoint.hp == 0) {
                try {
                 ...
                 new Saibamen6(this.zone, 2, Util.nextInt(1000, 10000), BossType.SAIBAMEN_5);   
