...
public class Saibamen3 extends Boss {
    ...
    public Saibamen3(Zone zone , int level, long dame, long hp) throws Exception {
        super(BossType.SAIBAMEN_3, new BossData(
                "số 3",
           ...
           if (plAtt != null && !piercing && effectSkill.isShielding) {
            ...
            if (this.nPoint.hp == 0) {
                try {
                 ...
                 new Saibamen4(this.zone, 2, Util.nextInt(1000, 10000), BossType.SAIBAMEN_3);   
