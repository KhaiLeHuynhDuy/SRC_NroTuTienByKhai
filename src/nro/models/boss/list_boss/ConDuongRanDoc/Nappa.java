...
public class Nappa extends Boss {
    ...
    public Nappa(Zone zone , int level, long dame, long hp) throws Exception {
        super(BossType.NAPPA, new BossData(
                "Nappa",
    ...
    public void reward(Player plKill) {
      plKill.inventory.event++;
        ...
        if (Util.isTrue(100, 100)) {
            ItemMap it = new ItemMap(this.zone, 457, 15, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
        ...
        damage = this.nPoint.subDameInjureWithDeff(damage);
            ...
            if (this.nPoint.hp == 0) {
                try {
                    ...
                    new Vegeta(this.zone, 2, Util.nextInt(1000, 10000), BossType.SAIBAMEN_7);
