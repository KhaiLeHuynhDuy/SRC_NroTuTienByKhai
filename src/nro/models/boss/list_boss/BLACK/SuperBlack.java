...
public class SuperBlack extends Boss {

    public SuperBlack() throws Exception {
        super(Util.randomBossId(), BossesData.SUPER_BLACK_GOKU);
    }
    ...
    public void active() {
        ...
        try {
            ...
            Logger.logException(SuperBlack.class, ex);
        }
        this.attack();
