...
public class TrungUyXanhLo extends TrungUyTrang {
    ...
    public TrungUyXanhLo(long dame, long hp, Zone zone) throws Exception {
        super(dame, hp, zone, BossType.TRUNG_UY_XANH_LO, TRUNG_UY_XANH_LO);
    }
   ...
   @Override
    public void reward(Player pl) {
        ...
        if (Util.isTrue(9, 10)) {
            Service.gI().dropItemMap(this.zone, new ItemMap(zone, 661, 1, this.location.x, zone.map.yPhysicInTop(this.location.x, this.location.y - 24), pl.id));
        } else {
