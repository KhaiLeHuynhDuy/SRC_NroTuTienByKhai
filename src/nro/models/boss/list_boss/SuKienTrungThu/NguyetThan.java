...
public class NguyetThan extends Boss {
    ...
    public static int flag = 1; // cờ đỏ

    public NguyetThan() throws Exception {
        super(BossType.NGUYET_THAN, BossesData.NguyetThan);
    }
...
//    }
    ...
    public void reward(Player plKill) {
        ...
        if (plKill.isPl()) {
            if (plKill.isUseKiemGo) {
                ...
                ctNguyetThan.options.add(new Item.ItemOption(50, Util.nextInt(30, 50)));
                ctNguyetThan.options.add(new Item.ItemOption(77, Util.nextInt(30, 50)));
                ctNguyetThan.options.add(new Item.ItemOption(103, Util.nextInt(30, 50)));
                ctNguyetThan.options.add(new Item.ItemOption(5, Util.nextInt(30, 50)));
        ...
        if (Util.canDoWithTime(this.lastTimeAttack, 1000) && changeFlag) {
            ...
            try {
                ...
                if (Util.getDistance(this, pl) <= this.getRangeCanAttackWithSkillSelect()) {
                    ...
                    if (!this.isDie() && this != null && pl != null) {
    ...
    public Player getPlayerAttack() {
        ...
        if (this.getPlayerTarget() == null || Util.canDoWithTime(this.getLastTimeTargetPlayer(), this.getTimeTargetPlayer())) {
            this.setPlayerTarget(this.zone.getPlayerWithFlagNotIsRed(playerThis));
    ...
    public double injured(Player plAtt, double damage, boolean piercing, boolean isMobAttack) {
        if (!this.isDie()) {
            ...
            if (plAtt != null & plAtt.isBoss && this.nPoint.hp <= 100) {
                damage = 0;
            }
