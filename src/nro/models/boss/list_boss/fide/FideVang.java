...
public class FideVang extends Boss {

    public FideVang() throws Exception {
        super(BossType.FIDE2, BossesData.FIDE_COMEBACK, BossesData.FIDE_COMEBACK_2, BossesData.FIDE_COMEBACK_3);
    }
...
@Override
    ...
    public void active() {
        ...
        try {
            ...
            Logger.logException(FideVang.class, ex);
        }
        this.attack();
