package nro.models.boss.list_boss.fide;
...
public class Fide extends Boss {
    ...
    public Fide() throws Exception {
        super(BossType.FIDE, BossesData.FIDE_DAI_CA_1, BossesData.FIDE_DAI_CA_2, BossesData.FIDE_DAI_CA_3);
    }
    ...
    public void reward(Player pl) {
        ...
        if (Util.isTrue(1, 10)) {
            ...
            Service.gI().dropItemMap(this.zone, new ItemMap(zone, 861, 10000, this.location.x, zone.map.yPhysicInTop(this.location.x, this.location.y - 24), pl.id));
        ...
        if (Util.isTrue(1, 10)) {
            ...
            Service.gI().dropItemMap(this.zone, new ItemMap(zone, 462, 1, this.location.x + 6, zone.map.yPhysicInTop(this.location.x, this.location.y - 24), pl.id));
    ...
    public void active() {
        ...
        try {
            ...
            Logger.logException(Fide.class, ex);
        }
        this.attack();
