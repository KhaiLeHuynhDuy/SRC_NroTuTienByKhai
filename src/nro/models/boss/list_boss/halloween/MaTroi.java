...
public class MaTroi extends Boss {
    ...
    public static final BossData MATROI = new BossData(
            //            "Ma trơi", //name
            "PICO TET", //name
            ConstPlayer.XAYDA, //gender
            //            new short[]{651, 652, 653, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            //            new short[]{943, 944, 945, -1, -1, -1}, //
            new short[]{1755, -1, -1, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            5000, //dame
    ...
    public void active() {
        ...
        try {
            ...
            Logger.logException(MaTroi.class, ex);
        }
        this.attack();
