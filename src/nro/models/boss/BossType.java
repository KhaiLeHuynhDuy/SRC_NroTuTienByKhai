...
//   
    ...
    public static final int XEN_CON_1 = 2_147_480_111;
    ...
    public static final int GRANONA = -108;
    public static final int OLL = -109;
    public static final int GAS = -110;
    public static final int ELEC = -111;
    public static final int MACKI = -112;

    public static final int GOHAN = -114;
    ...
    public static final int BROLY_SUPER = 107;
    ...
    public static final int GROUP_ADR = 1000;

    public static final int BU_MAP = 500;

    public static final byte MA_TROI = 107;

    public static final byte CHILL = 108;
    public static final byte NGUYET_THAN = 109;
    public static final byte NHAT_THAN = 110;
    public static final byte DOI = 111;
    ...
    public static final int FIDE2 = 118;
    public static final int TOP_PO = 119;
    public static final int JEM_NI_BA = 120;
    public static final int HEART = 121;
    public static final int HUTAO = 122;
