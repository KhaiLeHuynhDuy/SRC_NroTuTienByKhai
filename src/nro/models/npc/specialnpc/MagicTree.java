...
public class MagicTree {
    ...
    public static final byte MAX_LEVEL = 11;

    public static final short[] PEA_TEMP = {13, 60, 61, 62, 63, 64, 65, 352, 523, 595, 1997};
    public static final int[] PEA_PARAM = {100, 500, 3, 8, 20, 60, 150, 400, 1200, 3000, 15000};
    ...
    private static final int[][][] POS_PEAS = {
        ...
        {{32, 86}, {5, 77}, {25, 77}, {8, 89}, {29, 68}, {4, 63}, {18, 61}, {33, 53}, {8, 48}, {26, 39}, {11, 36}, {33, 23}, {18, 25}, {4, 20}, {26, 12}, {12, 7}, {19, 0}, {19, 0}, {19, 0}, {19, 0}, {19, 0}, {19, 0}, {19, 0}, {19, 0}, {19, 0}}};

    //days - hours - mins - gold - gem
    private static final short[][] PEA_UPGRADE = {
        {0, 0, 10, 5, 100}, {0, 1, 40, 10, 100}, {0, 16, 40, 100, 100}, {6, 22, 0, 1, 100},
        {13, 21, 0, 10, 100}, {27, 18, 0, 20, 100}, {55, 13, 0, 50, 100}, {69, 10, 0, 100, 100},
        {104, 4, 0, 300, 100}, {215, 15, 0, 2000, 500}, {0, 0, 0, 0, 500}
    };

    //icon magic tree [gender][level]
    private static final short[][] ID_MAGIC_TREE = {
        {84, 85, 86, 87, 88, 89, 90, 90, 90, 90, 90},
        {371, 372, 373, 374, 375, 376, 377, 377, 377, 377, 377},
        {378, 379, 380, 381, 382, 383, 384, 384, 384, 384, 384}};
    ...
    public void upgradeMagicTree() {
        long gold = PEA_UPGRADE[this.level - 1][3];
        long goldRequire = gold * (this.level <= 3 ? 1000 : 1000000);
    ...
    public void unupgradeMagicTree() {
        long gold = PEA_UPGRADE[this.level - 1][3];
        long goldReturn = (gold * (this.level <= 3 ? 1000 : 1000000)) / 2;
    ...
    public void fastRespawnPea() {
        int gem = PEA_UPGRADE[this.level - 1][4];
        int gemRequire = gem;
        if (this.player.inventory.gem < gemRequire) {
            Service.gI().sendThongBao(player, "Bạn không đủ ngọc xanh để kết hạt nhanh, còn thiếu "
                    + (gemRequire - this.player.inventory.gem) + " ngọc xanh nữa");
        } else {
            //giá kết hạt nhanh
