...
public final class MobMe extends Mob {
        ...
        try {
            if (pl != null) {
                if (pl.nPoint.hp > this.point.dame && pl.nPoint.hp > pl.nPoint.hpMax * 0.05) {
                    ...
                    msg.writeFix(Util.maxIntValue(dameHit)); // long
                    msg.writeFix(Util.maxIntValue(pl.nPoint.hp)); // long
            ...
            if (mob != null) {
                if (mob.point.gethp() > this.point.dame) {
                    ...
                    msg.writeFix(Util.maxIntValue(this.point.dame)); // long
                    Service.gI().sendMessAllPlayerInMap(this.zone, msg);
                    msg.cleanup();
    ...
    public void spawn() {
        ...
        try {
            ...
            msg.writeFix(Util.maxIntValue(this.point.hp));// hp mob
            Service.gI().sendMessAllPlayerInMap(this.zone, msg);
            msg.cleanup();
        } catch (Exception e) {            e.printStackTrace();
