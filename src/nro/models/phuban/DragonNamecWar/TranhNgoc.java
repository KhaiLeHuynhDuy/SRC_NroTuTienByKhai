...
public class TranhNgoc {
    ...
    public static final byte HOUR_REGISTER = 23;
    public static final byte MIN_REGISTER = 10;
    public static final byte HOUR_OPEN = 23;
    public static final byte MIN_OPEN = 14;
